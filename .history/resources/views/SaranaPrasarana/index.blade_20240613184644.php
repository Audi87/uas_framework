        ...
        {{-- Sarana dan prasana --}}
            ...
            <div class="row mb-3 gx-1">
                ...
                <div class="col-lg-4 mb-2">
                    <div class="card p-3">
                       < href="{{ asset('storage/' . $barang->image) }}" target="_blank"><img src="{{ asset('storage/post-image' . $barang->image) }}" class="card-img-top img-fluid" alt="..." title="{{ $barang->nama_barang }}" data-aos="flip-left" data-aos-duration="2000"></>
                        <div class="card-body">
