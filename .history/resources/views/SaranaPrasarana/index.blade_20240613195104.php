                ...
                <div class="col-lg-4 mb-2">
                    <div class="card p-3">
                        <a href="{{ asset('storage/' . $barang->image) }}" >
                            <img src="{{ $barang->image ? asset('storage/post-image/' . $barang->image) : '' }}')" class="card-img-top img-fluid" alt="..." title="{{ $barang->nama_barang }}" data-aos="flip-left" data-aos-duration="2000">
                        </a>
                        <div class="card-body">
