                ...
                <div class="row mb-3 gx-1">
                    @foreach ($barangs as $barang)
                        <div class="col-lg-4 mb-2">
                            <div class="card p-3" s>
                                <div class="foto" style="align-items: center">
                                    <a href="{{ asset('storage/' . str_replace('public/', '', $barang->image)) }}"
                                        target="_blank">
                                        <img src="{{ asset('storage/' . str_replace('public/', '', $barang->image)) }}"
                                            width="150px" title="{{ $barang->nama_barang }}">
                                    </a>
                                </div>
                                <div>
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><strong>Category : </strong>{{ $barang->category->category }}
                                        </p>
