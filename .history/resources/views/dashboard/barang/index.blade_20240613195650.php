                ...
                <table class="table table-sm table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $barang->stok }}</td>
                            <td>
                                    <a href="{{ asset('storage/public/post-image/' . $barang->image) }}" target="_blank">
                                        <img src="{{ asset('storage/public/post-image/' . $barang->image) }}" width="50" title="{{ $barang->nama_barang }}">
                                    </a>
