                ...
                <small>
                    <table class="table table-sm table-bordered table-striped">
                        ...
                        <tbody>
                                ...
                                <td>
                                    @if($barang->image)
                                        <a href="{{ asset('storage/' . $barang->image) }}" target="_blank">
                                            <img src="{{ asset('storage/' . $barang->image) }}" width="50" title="{{ $barang->nama_barang }}">
                                        </a>
                                    @endif
                                </td>
                                <td>
                            ...
                            <tr>
                                <td colspan="6">Sarana atau Prasarana <strong style="font-style: italic" class="text-danger">"{{ request('search') }}"</strong> tidak tersedia!</td>
                            </tr>
