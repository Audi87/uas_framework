    ...
    <div class="container-fluid" id="container-fluid">
        <div class="container1">
            ...
            <div class="row text-white text-center d-flex justify-content-center mt-5">
                <div class="col-lg-8">
                    <h1>Peminjaman Barang dan Ruangan<h1> <n>Sistem Informasi Logistik Telkom University</h1></n>
                </div>
            </div>

            <div class="row py-3 text-center mt-5" data-aos="flip-left" data-aos-duration="2000">
                <div class="col-lg-12">
                    <a href="sarana dan prasarana" class="btn btn-outline-danger btn-sm">Sarana dan Prasarana</a>
                </div>
