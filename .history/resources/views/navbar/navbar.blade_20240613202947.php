                ...
                @auth
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="/profil/{{ auth()->user()->id }}"><i
                                        class="bi bi-person-lines-fill"></i> My Profil</a></li>
                            <li>
                            ...
                            <form action="/logout" method="post">
                                ...
                                <button type="submit" class="dropdown-item"
                                    onclick="return confirm('sure want to go out?')"><i class="bi bi-box-arrow-in-left"></i>
                                    Logout</button>
                            </form>
                            {{-- End From --}}
                        </ul>
